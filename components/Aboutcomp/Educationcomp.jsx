    ...
    >
      <div className='flex flex-col justify-center gap-5 xsm:items-center xsm:flex-col'>
        ...
        <motion.div variants={itemVariants} className='flex justify-center items-start gap-5 xsm:flex-col xsm:items-center lg:flex-row'>
          <div className='border border-sky-900 lg:h-[12rem] flex items-center justify-center lg:w-44 xsm:h-[5rem] xsm:w-[17rem] sm:w-[40rem]'>
          ...
          <div className='lg:h-[6rem] lg:w-[10rem] flex items-center justify-center md:w-[40rem]'>
            <iframe

...
const HireMe = () => {
  ...
  return (
    <div>
    <div className="bg-gradient-to-r  from-blue-900 to-cyan-900 text-white p-8 rounded-lg shadow-lg border border-blue-500 flex flex-row lg:flex-row justify-center items-center lg:w-[60rem] gap-10 xsm:w-[25rem] sm:w-[40rem]">
      <div className="lg:w-1/2">
        <h2 className="text-4xl font-bold text-center mb-6">Hire Me</h2>
        <motion.form 
          className="space-y-6"
      ...
      <div className="xsm:hidden sm:flex">
        <Image 
          ...
          width={500} 
          height={500} 
          className="rounded-lg shadow-lg sm:w-[20rem]"
          alt="Hire Me"
        />
      </div>
